...
When ``FLUXSERVE_CUDA_COREDUMP=1``, this module injects CUDA coredump
...
def is_enabled() -> bool:
    return os.environ.get("FLUXSERVE_CUDA_COREDUMP", "0") == "1"


def get_dump_dir() -> str:
    return os.environ.get("FLUXSERVE_CUDA_COREDUMP_DIR", "/tmp/fluxserve-cuda-coredumps")
...
def report():
    ...
    if run_id:
        repo = os.environ.get("GITHUB_REPOSITORY", "lightseekorg/FluxServe")
...
_SENTINEL = "_FLUXSERVE_CUDA_COREDUMP_INJECTED"
